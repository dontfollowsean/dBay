...
contract('Simple Order Tests', function (accounts) {
    ...
    it("should be able to add a limit buy order", function () {
    ...
    it("should be able to add three limit buy orders", function () {
        var myExchangeInstance;
    ...
    it("should be able to add two limit sell orders", function () {
        var myExchangeInstance;
        return exchange.deployed().then(function (instance) {
            myExchangeInstance = instance;
