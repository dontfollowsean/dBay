...
contract('Exchange Basic Tests', function (accounts) {
    it("should be able to add tokens", function () {
        ...
        return fixedSupplyToken.deployed().then(function (instance) {
            ...
            assert.equal(txResult.logs[0].event, "TokenAddedToSystem", "TokenAddedToSystem Event should be emmitted");
    ...
    it("should be able to deposit and withdraw Ether", function () {
        ...
        return exchange.deployed().then(function (instance) {
            ...
            // gas is rounded so cannot check for exact value. use at least instead
